...
class RobotControl:
    def __init__(self):
        ...
        rospy.init_node('move_robot_backward_double_speed_ticks', anonymous=True)
    ...
    def move_backward(self, target_ticks):
        ...
        # Set the robot's velocity to move backward at double speed (linear velocity < 0)
        self.cmd_msg.v = -1.0  # Move backward at 1.0 m/s (double speed)
        ...
        rospy.loginfo("Started moving backward at double speed...")
...
if __name__ == '__main__':
    try:
        # Instantiate the RobotControl class and move backward 150 ticks at double speed
