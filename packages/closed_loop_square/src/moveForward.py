...
class RobotControl:
    def __init__(self):
        ...
        rospy.init_node('move_robot_forward_ticks', anonymous=True)
    ...
    def move_forward(self, target_ticks):
        ...
        # Set the robot's velocity to move forward (linear velocity > 0)
        self.cmd_msg.v = 0.5  # Move forward at 0.5 m/s
...
if __name__ == '__main__':
    try:
        # Instantiate the RobotControl class and move forward 150 ticks
