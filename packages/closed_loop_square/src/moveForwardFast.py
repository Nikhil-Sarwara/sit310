...
class RobotControl:
    def __init__(self):
        ...
        rospy.init_node('move_robot_forward_fast_double_speed_ticks', anonymous=True)
    ...
    def move_forward(self, target_ticks):
        ...
        # Set the robot's velocity to move forward at double speed (linear velocity > 0)
        self.cmd_msg.v = 1.0  # Move forward at 1.0 m/s (double speed)
        ...
        rospy.loginfo("Started moving forward at double speed...")
...
if __name__ == '__main__':
    try:
        # Instantiate the RobotControl class and move forward 150 ticks at double speed
        robot_control = RobotControl()
        robot_control.move_forward(150)
