...
class RobotControl:
    ...
    def turn_clockwise(self, target_ticks):
        ...
        self.cmd_msg.omega = -1.0  # Turn clockwise (negative omega)

        # Publish the command to start turning
        self.cmd_msg.header.stamp = rospy.Time.now()
        self.cmd_pub.publish(self.cmd_msg)

        rospy.loginfo("Started turning clockwise...")
...
if __name__ == '__main__':
    try:
        # Instantiate the RobotControl class and turn clockwise for 50 ticks
